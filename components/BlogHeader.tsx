...
export default function BlogHeader({ backLabel, backHref = "/" }: { backLabel?: string; backHref?: string }) {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-white/60 bg-white/72 shadow-[0_8px_30px_rgba(255,255,255,0.25)_inset,0_12px_40px_rgba(0,0,0,0.05)] backdrop-blur-[24px] hero-nav-transition">
