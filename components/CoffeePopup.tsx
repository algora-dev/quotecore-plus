      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
        <div className="pointer-events-auto relative flex w-full max-w-3xl overflow-hidden rounded-2xl bg-white shadow-[0_32px_80px_rgba(0,0,0,0.2)]">
          ...
          <div className="flex flex-1 flex-col justify-between p-7 sm:p-8">
            <div>
              <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[#D45A28]">Limited offer</p>
              ...
              <div className="mt-2 h-0.5 w-16 rounded-full bg-[#E85D2B]" />
              ...
              <div className="mt-5 space-y-3 text-sm leading-relaxed text-zinc-600">
                ...
                <p>
                  If you&apos;re not happy with the result... <span className="font-semibold text-[#D45A28]">Get a free coffee on us! ☕️</span>
                </p>
              </div>
            </div>
            ...
            <div className="mt-7">
              <a
                ...
                onClick={dismiss}
                className="flex w-full items-center justify-center gap-2 rounded-full bg-[#E85D2B] px-6 py-3.5 text-sm font-semibold text-white transition-colors hover:bg-[#D45A28]"
              >
              ...
              <p className="mt-3 text-center text-xs leading-relaxed text-zinc-400">
                ...
                <a href="https://quote-core.com/coffee-terms" target="_blank" rel="noopener noreferrer" className="text-[#D45A28] hover:underline">
                  T&amp;Cs apply.
                </a>
              </p>
            </div>
