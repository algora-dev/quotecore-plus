...
| **Starter** | $19/mo (~~$40~~) | 25 | 200 MB | Manual quotes, accept pages |
| **Growth** | $29/mo (~~$60~~) | 50 | 2 GB | + Digital takeoff, email send |
| **Professional** | $39/mo (~~$90~~) | 100 | 3 GB | + Flashings, material orders, follow-ups |
| **Pro Plus** | $59/mo (~~$120~~) | 200 | 5 GB | Higher caps, 3 included seats |
| **Premium** | Coming soon | — | — | Extra features, larger caps |

<Callout type="note">
The strikethrough prices are the original / MSRP price. The shown price is our launch pricing and renews at the launch price as long as you stay subscribed.
</Callout>

For the full caps breakdown (components, flashings, material orders), see [Tier limits](/docs/account/tier-limits).
...
5. **Day 75** — `pending_data_purge`. Final warning before deletion.

</Steps>

You can recover any time before the purge by updating your card in the portal.
