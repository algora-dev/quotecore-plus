...
<Callout type="note">
The strikethrough prices are the original MSRP for reference only. The listed price is what you pay - no coupons or discount codes involved. Every plan is covered by a [30-day money-back guarantee](/docs/account/trial).
</Callout>
