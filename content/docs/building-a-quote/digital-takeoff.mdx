...
- A digital takeoff version of the image showing your lines, measurements, areas, and items.

This is useful for printing out and doing site measures, or to clearly define what you actually measured at a later point if you need to reference it.

## Related

- [Quote builder](/docs/building-a-quote/quote-builder)
- [Manual takeoff](/docs/building-a-quote/manual-takeoff) - if you measured on site instead.
