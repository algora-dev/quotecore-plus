...
The component is in the dropdown when you add components in [manual takeoff](/docs/building-a-quote/manual-takeoff) or [digital takeoff](/docs/building-a-quote/digital-takeoff). You can edit or delete it any time; editing does not change quotes you have already built.
