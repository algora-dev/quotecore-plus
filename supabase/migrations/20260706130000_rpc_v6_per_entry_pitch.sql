-- Migration: 20260706130000_rpc_v6_per_entry_pitch.sql
-- Purpose: Store pitch per child area entry, stop overwriting parent pitch.
--
-- Changes from v5 (20260705230000):
--   Section 8: INSERT into quote_roof_area_entries now includes pitch_degrees.
--   Section 8: Parent calc_pitch_degrees only set when currently NULL/0
--   (first area wins; subsequent areas don't overwrite the parent's pitch).
--
