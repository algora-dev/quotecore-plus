-- Migration: 20260805160000_supplier_read_tax_fields.sql
-- Update public_supplier_read RPC to include tax_name, tax_rate,
-- price_list_includes_tax, and takeoff_library_includes_tax fields
-- These fields are needed by the supplier landing page to display
-- full tax details (e.g. "Prices include GST (15%)")
