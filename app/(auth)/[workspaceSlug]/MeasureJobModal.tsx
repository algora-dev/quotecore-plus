      ...
      >
        ...
        <div className="px-6 py-4 border-t border-slate-200 flex items-center justify-between flex-shrink-0 bg-white rounded-b-2xl">
          ...
          <button
            ...
            aria-busy={creating}
            className={`inline-flex items-center justify-center gap-2 px-6 py-3 bg-black text-white font-medium rounded-full hover:bg-slate-800 transition-all ${
              creating
                ? 'cursor-progress'
                : 'disabled:opacity-50 disabled:cursor-not-allowed hover:shadow-[0_0_12px_rgba(255,107,53,0.4)]'
            }`}
          >
            {creating && (
