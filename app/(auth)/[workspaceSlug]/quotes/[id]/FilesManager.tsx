          ...
          <div>
            ...
            {planUrl && planName ? (
              <div className="space-y-3">
                {/* Plan thumbnail strip (2026-07-06): show all uploaded plans
                    with their assigned areas, not just the most recent one. */}
                {allPlans.length > 0 ? (
                  <div className="flex gap-3 overflow-x-auto pb-2">
                    {allPlans.map((plan) => (
                      ...
                      >
                        <a
                          href={plan.thumbnailUrl ?? '#'}
                          target="_blank"
                          rel="noopener noreferrer"
                          className="block"
                        >
                          <div className="relative w-28 h-20 rounded-lg border border-slate-200 overflow-hidden bg-slate-50 hover:border-orange-300 transition-colors">
                            {plan.thumbnailUrl ? (
                              <img
                ...
                {/* Digital Takeoff Button moved above Plans & Files dropdown in quote-builder.tsx (2026-07-06) */}
              </div>
            ) : (
              <FileUploader
