    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center backdrop-blur-sm bg-black/40" onClick={onClose}>
      ...
      >
        ...
        <div className="flex items-center justify-between">
          <h2 className="text-lg font-semibold text-slate-900">Paste Quote Details</h2>
        ...
        {success ? (
          <div className="flex items-start gap-3 rounded-lg border border-green-200 bg-green-50/50 p-4">
            ...
            <div>
              <p className="text-sm font-medium text-slate-900">Lines added to your quote</p>
              <p className="text-xs text-slate-500 mt-1">Review and edit the lines in your quote editor.</p>
            </div>
          </div>
        ) : (
          <>
