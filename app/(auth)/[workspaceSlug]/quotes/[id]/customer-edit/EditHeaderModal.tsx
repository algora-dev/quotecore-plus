...
export function EditHeaderModal({ companyName, companyAddress, companyPhone, companyEmail, companyLogoUrl, onSave, onCancel, onSaveAsTemplate }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center backdrop-blur-sm bg-black/40">
      <div className="bg-white rounded-xl border border-slate-200 shadow-xl p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 text-sm border border-slate-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 focus:outline-none"
              />
            </div>
            <div>
