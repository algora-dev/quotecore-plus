...
// Dedicated assistant PWA: home-screen installs launched from this page use
// their own manifest (start_url /assistant), so the icon opens straight into
// the assistant-only experience instead of the main app.
