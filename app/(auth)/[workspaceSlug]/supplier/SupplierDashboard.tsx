            ...
            <button onClick={() => setProfileExpanded(!profileExpanded)} className="w-full flex items-center justify-between px-5 py-4 hover:bg-slate-50/50 transition">
              <div className="flex items-center gap-3 min-w-0 flex-1">
                ...
                {logoUrl || profile.logo_url ? (
                  <img src={(logoUrl || profile.logo_url) ?? ''} alt="Logo" className="h-6 w-6 rounded-md border border-slate-200 object-contain flex-shrink-0" />
                ) : (
                  <div className="h-6 w-6 rounded-md border border-dashed border-slate-300 flex items-center justify-center text-slate-300 flex-shrink-0">
                ...
                <div className="flex items-center gap-2 min-w-0 flex-wrap">
                  <h2 className="text-sm font-semibold text-slate-900 whitespace-nowrap">Supplier Profile</h2>
                  <span className="text-slate-300">/</span>
                  <span className="text-xs text-slate-500 truncate">{profile.supplier_name}{profile.branch_city ? `, ${profile.branch_city}` : ''}{profile.branch_region ? `, ${profile.branch_region}` : ''}</span>
          ...
          <div className="rounded-xl border border-slate-200 bg-white mb-4 overflow-hidden">
            <button onClick={() => setUrlsExpanded(!urlsExpanded)} className="w-full flex items-center justify-between px-5 py-4 hover:bg-slate-50/50 transition">
              <div className="flex items-center gap-3 min-w-0 flex-1">
                ...
                <div className="flex items-center gap-2 min-w-0 flex-wrap">
                  <h2 className="text-sm font-semibold text-slate-900 whitespace-nowrap">Supplier Public URLs</h2>
                  <span className="text-slate-300">/</span>
                  <span className="text-xs text-slate-500 truncate">Links to your supplier page and roofing calculator</span>
                </div>
              </div>
