      ...
      >
        ...
        <div className="rounded-lg bg-blue-50 border border-blue-200 px-4 py-3">
          <p className="text-xs text-blue-700 leading-relaxed">
            Upload a photo or screenshot of an existing {documentType}, invoice, or handwritten notes.
            AI will read the document and pre-populate your {documentType} lines in our professional format,
        ...
        {status === 'done' && preview && (
          <div className="flex items-start gap-3 rounded-lg border border-green-200 bg-green-50/50 p-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-slate-500 mt-1">Lines have been added to your {documentType}. Review and edit as needed.</p>
            </div>
          </div>
        )}
