  ...
  return (
    <div className="mx-auto w-full max-w-5xl px-4 py-8 lg:px-6">
      ...
      <section className="mt-8">
        <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <p className="text-sm font-medium text-slate-700">
            Turn these measurements into a professional quote for your customer.
          </p>
          <div className="flex items-center gap-3">
            ...
            <Link
              ...
              className="text-sm font-semibold text-[#FF6B35] hover:text-[#ff5722]"
            >
              Start free trial
            </Link>
          </div>
