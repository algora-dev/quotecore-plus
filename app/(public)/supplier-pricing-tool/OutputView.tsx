// Final output: materials breakdown by group, totals. Trade pricing + actions land in Phase 4/5.
    ...
    <div className="space-y-4">
      <div className="bg-white rounded-xl border border-black p-6 md:p-10 space-y-6">
          ...
          <div key={def.key}>
            ...
            <div className="mt-2 overflow-x-auto">
              <table className="w-full text-sm">
                ...
                <tbody>
                  {lines.map(l => (
                    <tr key={l.productId} className="border-b border-black/10">
                      <td className="py-2 pr-2 text-black">{l.name}</td>
                      ...
                      <td className="py-2 text-right text-black font-semibold">{cur}{fmt(l.lineTotal)}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
        ...
        <div className="flex items-center justify-between border-t-2 border-black pt-4">
          ...
          <span className="text-xl font-bold text-black">{cur}{fmt(output.material)}</span>
        </div>
