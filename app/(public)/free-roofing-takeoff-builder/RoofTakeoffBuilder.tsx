              ...
              <div className="rounded-xl border border-slate-200 bg-slate-50/50 p-2 md:p-4 mb-5 flex items-center justify-between flex-wrap gap-2">
                <div className="flex items-center gap-3 flex-wrap">
                  ...
                  {selectedSupplier && (
                    <>
                      <div className="w-px h-4 bg-slate-200" />
                      <span className="text-sm font-bold text-[#FF6B35]">{selectedSupplier.supplierName}</span>
                      <button onClick={() => { setSelectedSupplier(null); setSupplierSkip(false); setUnitSystem(null); }} className="text-xs font-medium text-slate-400 hover:text-[#BD4A1A] transition rounded-full px-2 py-0.5 hover:bg-slate-100">
                        Change
                      </button>
                    </>
                  )}
                  {supplierSkip && (
                    <>
                      <div className="w-px h-4 bg-slate-200" />
                      <span className="text-sm font-bold text-[#FF6B35]">QuoteCore+</span>
                      <button onClick={() => { setSelectedSupplier(null); setSupplierSkip(false); setUnitSystem(null); }} className="text-xs font-medium text-slate-400 hover:text-[#BD4A1A] transition rounded-full px-2 py-0.5 hover:bg-slate-100">
                        Change
                      </button>
                    </>
