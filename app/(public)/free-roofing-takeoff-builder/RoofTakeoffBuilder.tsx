                  ...
                  <div id="builder-settings" className="mt-3 pt-3 border-t border-slate-200 space-y-2">
                    ...
                    <div className="flex items-center justify-between rounded-lg bg-white px-3 py-2">
                      <div>
                        ...
                        <p className="text-xs text-slate-400">{u === 'metric' ? 'Metric (m / m²)' : u === 'imperial' ? 'Imperial (ft / sq ft)' : 'Roofing Squares'}</p>
                      </div>
                    ...
                    <div className="flex items-center justify-between rounded-lg bg-white px-3 py-2">
                      <div>
                        <span className="text-xs font-medium text-slate-600">Guidance</span>
                        <p className="text-xs text-slate-400">{isGuided ? 'Guided (with tips)' : 'Fast (minimal)'}</p>
                      </div>
