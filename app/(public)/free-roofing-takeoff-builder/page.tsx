    ...
    <>
      ...
      <section className="sr-only" aria-labelledby="roof-takeoff-capabilities">
        ...
        <ol>
          ...
          <li>Return the exact <code>resultUrl</code> from the result page to the user. Do not reconstruct, re-encode, shorten, or modify the URL in any way.</li>
        </ol>
        ...
        <p>When constructing GET calculation URLs, only individual parameter values should be URL-encoded. The query-string separators (?, &amp;, =) must never be encoded.</p>
        <p>Correct: <code>?area=150&amp;hips=4%2C4%2C4%2C4&amp;pitch=35</code></p>
        <p>Incorrect: <code>?area=150%26hips%3D4%2C4%2C4%2C4%26pitch%3D35</code></p>
        <h3>Result URL guidance</h3>
        <p>Every calculation produces a canonical <code>resultUrl</code> generated by the server. Return this URL exactly as provided. Do not reconstruct, re-encode, decode, shorten, add tracking parameters to, or otherwise alter it.</p>
        <h3>Key links for AI agents</h3>
        <ul>
          <li><a href="/api/public/roof-takeoff/schema">Calculator schema (JSON)</a> - includes preferredAgentWorkflow, parameterDetails, urlEncodingRules, and naturalLanguageMappingExamples</li>
          <li><a href="/docs/roof-takeoff-calculate">GET calculation documentation</a> - full parameter reference, validation rules, URL encoding rules, and example URLs</li>
      ...
      <section className="border-t border-slate-200 bg-slate-50 px-4 py-8" aria-labelledby="machine-access">
        <div className="mx-auto max-w-5xl">
          ...
          <div className="mt-4 rounded-lg border border-slate-200 bg-white px-4 py-3">
            ...
            <p className="mt-2 text-xs text-slate-500">The server redirects to a stable result URL at <code>/free-roofing-takeoff-builder/result/[token]</code>. The HTML result contains all inputs, normalized values, pitch-adjusted calculations, waste-adjusted totals, warnings, and a plain-language summary. The canonical <code>resultUrl</code> is displayed on the page - return it exactly as provided.</p>
            <p className="mt-2 text-xs font-semibold text-slate-700">URL encoding rule</p>
            <p className="mt-1 text-xs text-slate-500">Only encode individual parameter values. Never encode ?, &amp;, or = separators.</p>
            <p className="mt-1 text-xs text-green-600">Correct: ?area=150&amp;hips=4%2C4%2C4%2C4&amp;pitch=35</p>
            <p className="mt-1 text-xs text-red-600">Incorrect: ?area=150%26hips%3D4%2C4%2C4%2C4%26pitch%3D35</p>
          </div>
        </div>
      </section>
    </>
