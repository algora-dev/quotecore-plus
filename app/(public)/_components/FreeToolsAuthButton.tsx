  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <button
        ...
        className="rounded-full bg-[#BD4A1A] px-3 py-1.5 text-xs font-semibold text-white transition-all hover:bg-[#ff5722] hover:shadow-[0_0_12px_rgba(255,107,53,0.4)]"
      >
