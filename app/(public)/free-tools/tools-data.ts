...
export const TOOLS: ToolEntry[] = [
  ...
  { slug: 'measurement-to-quote-tool', name: 'Measurement-to-Quote Tool', industry: 'Trade', description: 'Already have measurements? Build reusable pricing components, enter areas and lengths, get instant priced results.', keywords: ['measurement', 'pricing', 'quote', 'csv', 'price list', 'component', 'catalog'], isCore: true, category: 'takeoff' },
  ...
  { slug: 'free-margin-calculator', name: 'Margin Calculator', industry: 'Trade', description: 'Calculate margin on a total or line by line. See selling price, profit and markup instantly.', keywords: ['margin', 'markup', 'profit', 'selling price', 'pricing'], isCore: true, category: 'calculator' },
  ...
  { slug: 'free-smart-component-creator', name: 'Smart Component Creator', industry: 'Roofing', description: 'Build smart roofing components with materials, waste, and costs.', keywords: ['smart component', 'component', 'material', 'quantity', 'cost', 'tiles'], isCore: false, category: 'calculator' },
