...
export const TOOLS: ToolEntry[] = [
  ...
  { slug: 'free-quote-builder', name: 'Quote Builder', industry: 'Trade', description: 'Build smart components from your price list or CSV, add measurements, get instant pricing.', keywords: ['quote builder', 'csv', 'price list', 'component', 'pricing', 'catalog'], isCore: true, category: 'takeoff' },
