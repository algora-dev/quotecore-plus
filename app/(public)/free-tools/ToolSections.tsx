    ...
    <section id="calculators" className="scroll-mt-24">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1.2fr_1fr] gap-6 md:gap-10 items-center">
        ...
        <div className="order-1 lg:order-2">
          ...
          <button onClick={() => document.getElementById('all-calculators')?.scrollIntoView({ behavior: 'smooth' })} className="mt-4 inline-flex items-center text-xs md:text-sm font-medium text-[#BD4A1A] hover:text-[#FF6B35] transition-colors">Browse all {calculatorCount} calculators &rarr;</button>
        </div>
      </div>
    </section>
  );
