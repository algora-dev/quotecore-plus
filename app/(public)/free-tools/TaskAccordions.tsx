...
const ITEMS: AccordionItem[] = [
  ...
  },
  {
    ...
    badge: 'Free &#183; No signup',
    toolName: 'Free Wall & Cladding Takeoff',
    benefits: [
      'Upload your own PDF or image plan and calibrate the scale',
      'Measure wall areas, cladding zones, trims, battens and openings on screen',
      'Walls measured as drawn - no pitch to worry about',
      'Defaults for cedar, corrugate, wrap and trims, or create up to 7 of your own components',
      'Nothing is saved unless you send the result into the app',
    ],
    cta: { label: 'Open Free Cladding Takeoff', href: '/free-cladding-takeoff' },
  },
  {
    ...
    badge: 'Free &#183; No signup',
    toolName: 'Free Flooring Takeoff',
    benefits: [
      'Upload your own PDF or image floor plan and calibrate the scale',
      'Trace each room - floor areas for plank, carpet and tile, lineal runs for skirting and scotia',
      'Defaults for timber plank, carpet, tile, underlay and trims, or create up to 7 of your own components',
      'Single items like adhesive and sundries counted by click',
      'Nothing is saved unless you send the result into the app',
    ],
    cta: { label: 'Open Free Flooring Takeoff', href: '/free-flooring-takeoff' },
  },
  {
