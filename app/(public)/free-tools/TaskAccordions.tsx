...
const ITEMS: AccordionItem[] = [
  ...
  },
  {
    ...
    heading: 'Already have measurements and need a takeoff?',
    support: 'Enter the areas and lengths you already have and produce a complete roof takeoff.',
    badge: 'Free',
    toolName: 'Roof Takeoff Builder',
    benefits: [
      'Input roof areas, ridges, hips, valleys, barges and spouting in one place',
      'Master pitch, per-component pitch, or per-entry pitch - full flexibility',
      'Switch between pitch-calculated and actual measurements on every entry',
      'Complete takeoff report with totals, waste allowances and printable PDF output',
    ],
    image: { src: '/free-tools/FreeRoofTakeOffTool2.png', alt: 'Roof Takeoff Builder' },
    cta: { label: 'Open Takeoff Builder', href: '/free-roofing-takeoff-builder' },
  },
  {
    id: 'calculate',
    icon: 'M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z',
