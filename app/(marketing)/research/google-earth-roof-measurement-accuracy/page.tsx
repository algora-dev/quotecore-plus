      ...
      <section className="pb-16"><div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mt-6 space-y-3">
          {[
            ...
            { q: "Can I turn the measurement into a quote?", a: <>Yes. In QuoteCore+ the <a href="/measurement-to-quote-tool" className="font-medium text-[#FF6B35] underline underline-offset-4">takeoff continues into quantities, materials, labour, waste and pricing</a>, then into a customer quote. The free workflow includes the seven default components; paid plans add permanent saved libraries, jobs, quotes, orders and invoices.</> },
