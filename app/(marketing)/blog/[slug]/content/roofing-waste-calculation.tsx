...
export default function Post() {
  return (
    <div className="prose prose-zinc max-w-none">
      ...
      <p>QuoteCore+ <Link href="/features/smart-components">Smart Components™</Link> can store repeatable material calculations, waste rules, pricing, drawings, and images for the way your business works. The <Link href="/roofing-estimating-software">roofing estimating software</Link> page explains how these components turn measurements into priced estimates. Build one with the <a href="/free-smart-component-creator">free Smart Component Creator</a>, or watch <a href="https://www.youtube.com/watch?v=1MOvQX-Lf_c">a roofing component quote created without digital measurement</a> to see material calculation in action.</p>
