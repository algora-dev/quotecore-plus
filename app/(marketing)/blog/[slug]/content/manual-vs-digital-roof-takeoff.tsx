...
export default function Post() {
  return (
    <div className="prose prose-zinc max-w-none">
      ...
      <p>Digital takeoff replaces the ruler and calculator with software. You upload a plan - an image, or an entire multi-page PDF where you pick the page you need - measure roof areas and lengths on screen, and the software calculates areas, pitch-adjusted surface areas, and material quantities automatically (in m², sq ft, or roofing squares - whatever your suppliers quote in).</p>
