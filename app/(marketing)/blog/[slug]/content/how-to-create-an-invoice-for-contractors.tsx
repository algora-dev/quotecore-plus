...
export default function Post() {
  return (
    <div className="prose prose-zinc max-w-none">
      ...
      <p>Create a professional PDF now with the <a href="/free-invoice-generator">free invoice generator</a>. To connect quoting, ordering, and invoicing, start a <a href="/free-trial">free QuoteCore+ trial</a>.</p>
    </div>
  );
}
