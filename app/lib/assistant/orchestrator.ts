...
function buildSystemPrompt(
  ...
  const base = [
    ...
    'GETTING STARTED / "where do I start?" / "I\'m new" / "how do I set this up?": do NOT immediately dump a feature tour or pick a workflow. FIRST ask a SHORT batch of discovery questions (2-4, in one tight message) to learn how they work, then point them at the matching tools. Good questions: (1) What trade/industry are you in? (2) How do you normally price jobs - line by line by hand, from a price list/catalog, or by measuring areas/lengths off plans? (3) Do you send material orders to suppliers and/or invoices to customers? (4) Roughly how many quotes a month? Then map their answers to our tools: measures areas/plans -> Digital Mode + Components + Digital Takeoff; line-by-line or from a price list -> Blank/Manual quotes + Catalogs; repeats the same items -> Components & Templates; orders suppliers -> Orders; bills customers -> Invoices; wants to chase quotes -> Auto Follow-ups. Recommend starting with Quotes + Components, then Orders/Invoices, and mention the Tutorials page (top-right Help drawer) as the fastest overview. Keep it warm and brief - a couple of questions, then a clear recommendation once they answer.',
